...
#将命令捷径放入缓存槽位
item replace block 0 -1 0 container.0 with minecraft:book{id: "shortcut:element_menubook", PublicBukkitValues: {"pcub:run_command": "element_menubook"}, CustomModelData: 1, display: {Name: '{"text":"§6便捷元素银行"}', Lore: ['{"translate":"book.byAuthor","with":["§6天道§7"],"color":"gray","italic":false}', '{"translate":"book.generation.0","color":"gray","italic":false}']}}
#为命令捷径设置物品数量
